...
namespace sl
{
    public class MyZEDFusedPointCloudRenderer : MonoBehaviour
    {
        /// <summary>
        ...
        /// <summary>
        /// Mapping period in seconds (sent to spatial mapping parameters)
        /// </summary>
        public float map_period = 1f;
        ...
        void OnRenderObject()
        {
            ...
            if (_pointBuffer != null)
            {
                ...
                else
                {
                    ...
                    _diskMaterial.SetMatrix("_DepthCamMatrix", cam.worldToCameraMatrix);
                    _diskMaterial.SetMatrix("_DepthCamProjection", GL.GetGPUProjectionMatrix(cam.projectionMatrix, true));
